/**
 * =========================================================================================
 * Project     : Arduino Uno 3-Axis Delta Parallel Robot Pick-and-Place Controller
 * Platform    : Arduino Uno / ATmega328P
 * Framework   : Arduino IDE 2.0+
 * Author      : Muhammad Fikri
 * License     : MIT
 * Description : Parallel kinematic delta robot calculating inverse trigonometry in fixed-point arithmetic, driving 3 stepper axes with linear interpolation and vacuum suction cup.
 * =========================================================================================
 */
...
void setup() {
    ...
    Serial.println(F("================================================================="));
    Serial.println(F(" Arduino Uno 3-Axis Delta Parallel Robot Pick-and-Place Controller"));
